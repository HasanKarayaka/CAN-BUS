...
//  sFilterConfig.FilterScale = CAN_FILTERSCALE_32BIT;
  ...
  sFilterConfig.FilterIdLow = 0x1FBF9000 << 3 | CAN_IDE_32 ; // 0x1FBF9000 bunun altıdaki mesajları da almicak
  ...
  sFilterConfig.FilterIdLow = 0x1AB04000 << 3 | CAN_IDE_32 ;
